...
insert into postings values (1, 208699			, 'Eris cplace', 1800, 2, '500 3rd St', 'San Francisco', 'CA', 'awesome place', 17236);
insert into postings values (2, 660659391		, 'Nikitas place', 1800, 2, '674 Bay St', 'San Francisco', 'CA', 'awesome place', 17236);
insert into postings values (3, 100000898798374	, 'Evgenys place', 1800, 2, 'Somewhere in palo Alto', 'Palo Alto', 'CA', 'awesome place', 17236);
